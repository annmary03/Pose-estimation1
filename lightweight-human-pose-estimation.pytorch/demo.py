...
if __name__ == '__main__':
    ...
    print("2. Push-Up")
    print("3. Squat")
    exercise = input("Enter choice (1/2/3): ").strip()

    exercise_map = {'1': 'bicep', '2': 'pushup', '3': 'squat'}
    exercise_type = exercise_map.get(exercise)
    print(f"Starting pose estimation for {exercise_type}...")
   ...
   # Run your pose estimation logic here first...
    ...
    def send_reps_to_unity(reps, exercise):
        data = {
        "exercise": exercise,
        "reps": int(reps)
    }
...
# Example send loop
   # for i in range(1, 6):
    #    send_reps_to_unity(i, "bicep curl")
     #   print(f"Sent reps: {i}")
      #  time.sleep(1)
    ...
    print("Exercise data sent to Unity.")
